  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Total Page Views" count={442236} percentage={59.3} extra={35000} />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Total Users" count={78250} percentage={70.5} color="success" extra={8900} />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Total Order" count={18800} percentage={27.4} isLoss color="warning" extra={1943} />
      </Grid>
      <Grid item xs={12} sm={6} md={4} lg={3}>
        <AnalyticEcommerce title="Total Sales" count={35078} percentage={27.4} isLoss color="error" extra={20395} />
      </Grid>
