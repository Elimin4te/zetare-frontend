...
import { handlerDrawerOpen } from 'lib/menuState';
        ...
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption">{intl.formatMessage({ id: 'menu-orientation-vertical' })}</Typography>
            </Stack>
          }
        />
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption">{intl.formatMessage({ id: 'menu-orientation-horizontal' })}</Typography>
            </Stack>
          }
        />
      </Stack>
