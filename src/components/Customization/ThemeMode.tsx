        ...
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption">{intl.formatMessage({ id: 'theme-mode-light' })}</Typography>
            </Stack>
          }
        />
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption">{intl.formatMessage({ id: 'theme-mode-dark' })}</Typography>
            </Stack>
          }
        />
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption">{intl.formatMessage({ id: 'theme-mode-auto' })}</Typography>
            </Stack>
          }
        />
      </Stack>
