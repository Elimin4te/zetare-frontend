        ...
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption">{intl.formatMessage({ id: 'theme-layout-default' })}</Typography>
            </Stack>
          }
        />
          ...
          <FormControlLabel
            ...
            label={
              <Stack alignItems="center" spacing={0.5}>
                ...
                <Typography variant="caption">{intl.formatMessage({ id: 'theme-layout-mini-drawer' })}</Typography>
              </Stack>
            }
          />
        )}
        <FormControlLabel
          ...
          label={
            <Stack alignItems="center" spacing={0.5}>
              ...
              <Typography variant="caption">{intl.formatMessage({ id: 'theme-layout-rtl' })}</Typography>
            </Stack>
          }
        />
      </Stack>
